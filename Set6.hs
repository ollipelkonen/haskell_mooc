...
--  (==) = todo
  Name n1 == Name n2 = map Data.Char.toLower n1 == map Data.Char.toLower n2
...
instance Eq a => Eq (List a) where
  Empty == Empty = True
  LNode n1 l1 == LNode n2 l2 = if n1 /= n2 then False else l1 == l2
  _ == _ = False
...
instance Price a => Price [a] where
  price a = foldr (\x y -> y + price x) 0 a
...
simplify (RationalNumber n d) = if g > 1 then simplify (RationalNumber (div n g) (div d g)) else RationalNumber n d
  where g = gcd n d
...
instance Num RationalNumber where
  ...
  signum (RationalNumber n1 d1) = RationalNumber (signum n1) 1
  fromInteger n1 = RationalNumber n1 1
