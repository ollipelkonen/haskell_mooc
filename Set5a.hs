...
get :: UpDown -> Int
get (UpDownIncreasing ud) = ud
get (UpDownDecreasing ud) = ud

-- tick increases an increasing counter by one or decreases a
-- decreasing counter by one
tick :: UpDown -> UpDown
tick ud = case ud of
  UpDownIncreasing x -> UpDownIncreasing (x+1)
  UpDownDecreasing x -> UpDownDecreasing (x-1)

-- toggle changes an increasing counter into a decreasing counter and
-- vice versa
toggle :: UpDown -> UpDown
toggle ud = case ud of
  UpDownIncreasing x -> UpDownDecreasing x
  UpDownDecreasing x -> UpDownIncreasing x
